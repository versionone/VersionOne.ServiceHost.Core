...
namespace VersionOne.ServiceHost.Core {
    public static class FileSys {
        ...
        public static bool IsSourceFileNewer(string source, string dest) {
            ...
            var sourceVer = GetFileVersion(source);
            var destVer = GetFileVersion(dest);
        ...
        public static int EntrySize(string fileordir) {
            ...
            if (Directory.Exists(fileordir)) {
                return 1 + Directory.GetFileSystemEntries(fileordir).Sum(entry => EntrySize(entry));
            }
        ...
        public static void Touch(string path) {
            ...
            var writeable = (attribs & (FileAttributes.Hidden | FileAttributes.System | FileAttributes.ReadOnly)) == 0;
